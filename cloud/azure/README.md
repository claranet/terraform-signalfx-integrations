...
| <a name="input_azure_spn_token_validity_duration_hours"></a> [azure\_spn\_token\_validity\_duration\_hours](#input\_azure\_spn\_token\_validity\_duration\_hours) | Azure Service Principal token/password duration in hours before it expires. Default to 2 years. | `number` | `17520` | no |
